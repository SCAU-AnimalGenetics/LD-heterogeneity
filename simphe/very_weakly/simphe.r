#Simulation of phenotypes controlled by very weakly tagged causal variants. Phenotypic heritability was 0.8 and QTL number was 100
library("data.table")
...
#Simulation of phenotypes controlled by very weakly tagged causal variants, 100 QTL were randomly selected on the genome
locinum<-sample(data2[data2[,1]%in%very_weak,1],100,replace=FALSE)
