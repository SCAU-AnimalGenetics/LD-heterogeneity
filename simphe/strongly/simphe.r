#Simulation of phenotypes controlled by strongly tagged causal variants. Phenotypic heritability was 0.8 and QTL number was 100
library("data.table")
...
#Simulation of phenotypes controlled by strongly tagged causal variants, 100 QTL were randomly selected on the genome
locinum<-sample(data2[data2[,1]%in%strong,1],100,replace=FALSE)
